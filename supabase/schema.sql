...
CREATE TABLE IF NOT EXISTS public.installation_records (
    ...
    -- Actual Materials Used (Internal Inventory Only, Not Client-Facing)
    actual_pvc_qty INT DEFAULT 0,
    actual_emt_qty INT DEFAULT 0,
    actual_imc_qty INT DEFAULT 0,
    actual_conduit_rsc_qty INT DEFAULT 0,
    actual_conduit_pvc_moulding_qty INT DEFAULT 0,
    actual_conduit_black_flexible_qty INT DEFAULT 0,
    actual_conduit_pvc_flexible_orange_qty INT DEFAULT 0,
    actual_conduit_other_type VARCHAR(100),
    actual_conduit_other_qty INT DEFAULT 0,
    actual_liquid_tight_connector_qty INT DEFAULT 0,
    actual_liquid_tight_flex_length VARCHAR(50),
    actual_elbow_emt90_qty INT DEFAULT 0,
    actual_elbow_imc90_qty INT DEFAULT 0,
    actual_elbow_rsc90_qty INT DEFAULT 0,
    actual_lb_qty INT DEFAULT 0,
    actual_lr_qty INT DEFAULT 0,
    actual_ll_qty INT DEFAULT 0,
    actual_body_c_qty INT DEFAULT 0,
    actual_t_qty INT DEFAULT 0,
    actual_connector_emt_set_screw_qty INT DEFAULT 0,
    actual_connector_emt_compression_qty INT DEFAULT 0,
    actual_coupling_emt_set_screw_qty INT DEFAULT 0,
    actual_coupling_emt_compression_qty INT DEFAULT 0,
    actual_clamp_c_two_hole_qty INT DEFAULT 0,
    actual_clamp_c_one_hole_qty INT DEFAULT 0,
    actual_clamp_strap_malleable_qty INT DEFAULT 0,
    actual_utility_box_qty INT DEFAULT 0,
    actual_square_box_qty INT DEFAULT 0,
    actual_octagon_box_qty INT DEFAULT 0,
    actual_junction_box_qty INT DEFAULT 0,
    actual_other_boxes_notes TEXT,
