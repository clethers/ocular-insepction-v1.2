...
export class ManagerWorkspace {
  ...
  renderDispatchTab() {
    ...
    return `
      <div class="form-card" style="padding: 1.5rem; background: var(--bg-card); border-radius: var(--radius-xl);">
        <h3 style="font-weight: 800; font-size: 1.1rem; color: var(--text-primary); margin: 0 0 1rem 0;">Field Inspector Workload & Capacity Grid</h3>

        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1.25rem;">
          ${inspectors.map(i => `
            <div style="padding: 1.25rem; background: rgba(15, 23, 42, 0.6); border: 1px solid var(--border-color); border-radius: var(--radius-lg);">
              <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.75rem;">
                <div style="display: flex; align-items: center; gap: 0.6rem;">
                  ...
                  <div>
                    <strong style="color: var(--text-primary); font-size: 0.9rem; display: block;">${i.name}</strong>
                    <span style="font-size: 0.75rem; color: var(--text-muted);">${i.region}</span>
                  </div>
                </div>
                <span class="badge" style="background: ${i.assigned >= i.capacity ? 'rgba(244, 63, 94, 0.15)' : 'rgba(16, 185, 129, 0.15)'}; color: ${i.assigned >= i.capacity ? '#F43F5E' : '#10B981'}; font-size: 0.7rem; font-weight: 700; padding: 0.2rem 0.5rem; border-radius: var(--radius-full);">
                  ${i.status}
                </span>
              </div>
              ...
              <div style="margin-top: 1rem;">
                <div style="display: flex; justify-content: space-between; font-size: 0.75rem; color: var(--text-muted); margin-bottom: 0.35rem;">
                  <span>Daily Job Allocation</span>
                  <span>${i.assigned} / ${i.capacity} Jobs</span>
                </div>
              ...
              <button type="button" class="btn btn-secondary btn-dispatch-job" data-inspector="${i.name}" style="width: 100%; justify-content: center; margin-top: 1rem; padding: 0.5rem; font-size: 0.775rem;">
  ...
  renderQATab() {
    return `
      <div class="form-card" style="padding: 1.5rem; background: var(--bg-card); border-radius: var(--radius-xl);">
        <h3 style="font-weight: 800; font-size: 1.1rem; color: var(--text-primary); margin-bottom: 1rem;">Pending Ocular Audits Quality Assurance Queue</h3>
        
        <div style="display: flex; flex-direction: column; gap: 1rem;">
          ${this.readyItems.length > 0 ? this.readyItems.map(item => `
            <div style="padding: 1.25rem; background: rgba(15, 23, 42, 0.5); border: 1px solid var(--border-color); border-radius: var(--radius-lg); display: flex; justify-content: space-between; align-items: center;">
              <div>
                <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.25rem;">
                  <strong style="color: var(--text-primary); font-size: 1rem;">${item.clientName || 'Commercial Client'}</strong>
  ...
  renderClientSearchTab() {
    return `
      <div class="form-card" style="padding: 1.5rem; background: var(--bg-card); border-radius: var(--radius-xl);">
        <h3 style="font-weight: 800; font-size: 1.1rem; color: var(--text-primary); margin-bottom: 0.5rem;">360° Client & Installation Account Search</h3>
        <p style="font-size: 0.825rem; color: var(--text-muted); margin-bottom: 1.25rem;">Search by Client Name, RN Number, Installation No., or Contact Phone Number.</p>
        ...
        <div style="padding: 1.5rem; background: rgba(15, 23, 42, 0.6); border: 1px solid var(--border-color); border-radius: var(--radius-lg);">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.25rem;">
            <div>
              <h4 style="margin: 0; color: var(--text-primary); font-size: 1.1rem;">Ayala Land Commercial EV Charging Depot</h4>
              <span style="font-size: 0.775rem; color: var(--text-muted);">Reference: RN-88092 | Contact: +63 917 555 0192</span>
            </div>
          ...
          <div style="display: flex; justify-content: space-between; position: relative; margin-top: 1.5rem;">
            <div style="text-align: center; flex: 1;">
              ...
              <span style="font-size: 0.75rem; font-weight: 700; color: var(--text-primary); display: block;">Audit Requested</span>
              <span style="font-size: 0.7rem; color: var(--text-muted);">Aug 08</span>
            </div>
            <div style="text-align: center; flex: 1;">
              <div style="width: 28px; height: 28px; border-radius: 50%; background: #10B981; color: #fff; display: flex; align-items: center; justify-content: center; margin: 0 auto 0.35rem auto; font-size: 0.75rem; font-weight: 800;">✓</div>
              <span style="font-size: 0.75rem; font-weight: 700; color: var(--text-primary); display: block;">Ocular Conducted</span>
              <span style="font-size: 0.7rem; color: var(--text-muted);">Aug 10</span>
            </div>
            <div style="text-align: center; flex: 1;">
              ...
              <span style="font-size: 0.7rem; color: var(--text-muted);">Aug 11 (Today)</span>
            </div>
            <div style="text-align: center; flex: 1; opacity: 0.5;">
              <div style="width: 28px; height: 28px; border-radius: 50%; background: rgba(255,255,255,0.1); color: var(--text-muted); display: flex; align-items: center; justify-content: center; margin: 0 auto 0.35rem auto; font-size: 0.75rem; font-weight: 800;">4</div>
              <span style="font-size: 0.75rem; font-weight: 700; color: var(--text-muted); display: block;">Install Scheduled</span>
  ...
  renderCalendarTab() {
    return `
      <div class="form-card" style="padding: 1.5rem; background: var(--bg-card); border-radius: var(--radius-xl);">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.25rem;">
          <h3 style="font-weight: 800; font-size: 1.1rem; color: var(--text-primary); margin: 0;">Inspector Field Visit Calendar & Dispatcher</h3>
        ...
        <div style="display: grid; grid-template-columns: repeat(7, 1fr); gap: 0.5rem; text-align: center; font-size: 0.8rem; margin-bottom: 0.5rem;">
          <strong style="color: var(--text-muted);">Mon</strong><strong style="color: var(--text-muted);">Tue</strong><strong style="color: var(--text-muted);">Wed</strong><strong style="color: var(--text-muted);">Thu</strong><strong style="color: var(--text-muted);">Fri</strong><strong style="color: var(--text-muted);">Sat</strong><strong style="color: var(--text-muted);">Sun</strong>
        </div>

        <div style="display: grid; grid-template-columns: repeat(7, 1fr); gap: 0.5rem;">
          ${Array.from({ length: 14 }).map((_, idx) => `
            <div style="padding: 0.75rem 0.5rem; min-height: 70px; background: rgba(15, 23, 42, 0.5); border: 1px solid ${idx === 10 ? 'var(--ecoworks-blue)' : 'var(--border-color)'}; border-radius: var(--radius-md); font-size: 0.75rem;">
              <span style="font-weight: 700; color: ${idx === 10 ? 'var(--ecoworks-blue)' : 'var(--text-muted)'};">Aug ${idx + 1}</span>
              ${idx === 10 ? '<div style="margin-top: 0.35rem; padding: 0.2rem; background: rgba(0,174,239,0.2); border-radius: 4px; color: #00AEEF; font-weight: 700; font-size: 0.675rem;">3 Visits Scheduled</div>' : ''}
            </div>
          `).join('')}
        </div>
      </div>
  ...
  renderTicketsTab() {
    return `
      <div class="form-card" style="padding: 1.5rem; background: var(--bg-card); border-radius: var(--radius-xl);">
        <h3 style="font-weight: 800; font-size: 1.1rem; color: var(--text-primary); margin-bottom: 1rem;">Customer Care Support Tickets & Escalations</h3>
        ...
        <div style="display: flex; flex-direction: column; gap: 0.75rem;">
          <div style="padding: 1rem; background: rgba(15, 23, 42, 0.5); border: 1px solid var(--border-color); border-radius: var(--radius-md); display: flex; justify-content: space-between; align-items: center;">
            <div>
              <div style="display: flex; align-items: center; gap: 0.5rem;">
                <strong style="color: var(--text-primary);">Subdivision Gate Permit Access Note</strong>
                <span class="badge" style="background: rgba(245, 158, 11, 0.2); color: #F59E0B; font-size: 0.7rem; font-weight: 800;">HIGH PRIORITY</span>
              </div>
              <span style="font-size: 0.775rem; color: var(--text-muted); display: block; margin-top: 0.25rem;">Client: Forbes Park Residence | Gate Code #9940 required for entry.</span>
            </div>
          ...
          <div style="padding: 1rem; background: rgba(15, 23, 42, 0.5); border: 1px solid var(--border-color); border-radius: var(--radius-md); display: flex; justify-content: space-between; align-items: center;">
            <div>
              <div style="display: flex; align-items: center; gap: 0.5rem;">
                <strong style="color: var(--text-primary);">Charger Specification Upgrade Request (7kW ➔ 22kW)</strong>
                <span class="badge" style="background: rgba(0, 174, 239, 0.15); color: #00AEEF; font-size: 0.7rem; font-weight: 800;">NORMAL</span>
              </div>
              <span style="font-size: 0.775rem; color: var(--text-muted); display: block; margin-top: 0.25rem;">Client requested 3-phase 22kW fast charger upgrade prior to installation.</span>
            </div>
            <button type="button" class="btn btn-secondary btn-resolve-ticket" style="padding: 0.35rem 0.65rem; font-size: 0.75rem;">Resolve Ticket</button>
          </div>
        </div>
  ...
  renderMaterialsTab() {
    return `
      <div class="form-card" style="padding: 1.5rem; background: var(--bg-card); border-radius: var(--radius-xl);">
        <h3 style="font-weight: 800; font-size: 1.1rem; color: var(--text-primary); margin-bottom: 1rem;">Aggregated Material Pick-List Requests</h3>

        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
          <div style="padding: 1rem; background: rgba(15, 23, 42, 0.6); border: 1px solid var(--border-color); border-radius: var(--radius-md);">
            <span style="font-size: 0.75rem; color: var(--text-muted); font-weight: 700; text-transform: uppercase;">uPVC Conduits (20mm)</span>
            <div style="font-size: 1.6rem; font-weight: 800; color: var(--ecoworks-blue); margin-top: 0.25rem;">145 Pipes</div>
            <span style="font-size: 0.725rem; color: var(--text-muted);">Required for upcoming week</span>
          </div>

          <div style="padding: 1rem; background: rgba(15, 23, 42, 0.6); border: 1px solid var(--border-color); border-radius: var(--radius-md);">
            <span style="font-size: 0.75rem; color: var(--text-muted); font-weight: 700; text-transform: uppercase;">63A 2-Pole Breakers</span>
            <div style="font-size: 1.6rem; font-weight: 800; color: #10B981; margin-top: 0.25rem;">18 Units</div>
            <span style="font-size: 0.725rem; color: var(--text-muted);">Schneider Electric brand</span>
          </div>

          <div style="padding: 1rem; background: rgba(15, 23, 42, 0.6); border: 1px solid var(--border-color); border-radius: var(--radius-md);">
            <span style="font-size: 0.75rem; color: var(--text-muted); font-weight: 700; text-transform: uppercase;">EMT Conduits (3/4")</span>
            <div style="font-size: 1.6rem; font-weight: 800; color: #F59E0B; margin-top: 0.25rem;">82 Pipes</div>
            <span style="font-size: 0.725rem; color: var(--text-muted);">Galvanized steel</span>
          </div>
        </div>
      </div>
    `;
