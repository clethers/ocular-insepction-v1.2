        ...
        <aside class="app-sidebar no-print ${isCollapsed ? 'collapsed' : ''}" id="app-sidebar">
          ...
          <nav class="sidebar-nav" aria-label="Main Portal Navigation">
            ...
            ${isAdmin ? `
              ...
              <a href="/admin/clients" class="sidebar-nav-btn ${isActive('/admin/clients') ? 'active' : ''}" title="Client Directory & Record Archiving">
            ...
            ${isManager ? `
              ...
              <a class="sidebar-nav-btn disabled" title="Workload & Dispatch (Coming Soon)" aria-disabled="true">
              ...
              <a href="/manager/installations" class="sidebar-nav-btn ${isActive('/manager/installations') ? 'active' : ''}" title="Installations">
              ...
              <a class="sidebar-nav-btn disabled" title="Material Demand & Allocation (Coming Soon)" aria-disabled="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
                <span>Material Demand</span>
              </a>

              <a class="sidebar-nav-btn disabled" title="Operations KPIs (Coming Soon)" aria-disabled="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>
                <span>Operations KPIs</span>
              </a>
            ` : ''}

            <div class="nav-section-label" style="margin-top: 1.25rem;">INSPECTION</div>
            ...
            <div class="nav-section-label" style="margin-top: 1.25rem;">OPERATIONS TEAM</div>

            <a href="/ocular/assigned" class="sidebar-nav-btn ${isActive('/ocular/assigned') ? 'active' : ''}" title="Assigned Inspections Queue">
